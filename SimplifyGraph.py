...
def parse_cigar_diversity(cigar_tuples, delta_perc, delta_len):
    """Parses the cigar tuples generated by the parasail alignment
    INPUT:  cigar_tuples:       the cigar tuples we use
            delta_perc:         a threshold used to decide whether the sequences are close enough
            delta_len:          a threshold used to detect structural variants
    OUTPUT: poppable:           a boolean value indicating whether we pop the bubble"""
    miss_match_length = 0
    alignment_len = 0
